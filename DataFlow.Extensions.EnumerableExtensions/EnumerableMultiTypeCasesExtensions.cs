...
/// <summary>
/// Multi-type SelectCase extensions for IEnumerable.
...
public static class EnumerableMultiTypeCasesExtensions
{
    ...
    // ===================== 2 Types =====================
    public static IEnumerable<(int category, T item, (R1?, R2?) result)>
        SelectCase<T, R1, R2>(
    ...
    // ===================== 3 Types =====================
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?) result)>
    ...
    // ===================== 4 Types =====================
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?) result)>
    ...
    // ===================== 5 Types =====================
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?) result)>
    ...
    // ===================== 6 Types =====================
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?, R6?) result)>
    ...
    // ===================== 7 Types =====================
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?, R6?, R7?) result)>
    ...
    public static IEnumerable<(int category, T item, (R1?, R2?) result)>
        ForEachCase<T, R1, R2>(
            this IEnumerable<(int category, T item, (R1?, R2?) result)> items,
            Action<R1> action1,
            Action<R2> action2)
    {
    ...
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?) result)>
        ForEachCase<T, R1, R2, R3>(
            this IEnumerable<(int category, T item, (R1?, R2?, R3?) result)> items,
            Action<R1> action1,
            Action<R2> action2,
            Action<R3> action3)
    {
    ...
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?) result)>
        ForEachCase<T, R1, R2, R3, R4>(
            this IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?) result)> items,
            Action<R1> action1,
            Action<R2> action2,
            Action<R3> action3,
            Action<R4> action4)
    ...
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?) result)>
        ForEachCase<T, R1, R2, R3, R4, R5>(
            this IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?) result)> items,
            Action<R1> action1,
            Action<R2> action2,
            Action<R3> action3,
            Action<R4> action4,
    ...
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?, R6?) result)>
        ForEachCase<T, R1, R2, R3, R4, R5, R6>(
            this IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?, R6?) result)> items,
            Action<R1> action1,
            Action<R2> action2,
            Action<R3> action3,
            Action<R4> action4,
    ...
    public static IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?, R6?, R7?) result)>
        ForEachCase<T, R1, R2, R3, R4, R5, R6, R7>(
            this IEnumerable<(int category, T item, (R1?, R2?, R3?, R4?, R5?, R6?, R7?) result)> items,
            Action<R1> action1,
            Action<R2> action2,
            Action<R3> action3,
            Action<R4> action4,
