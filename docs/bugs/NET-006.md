...
## Files Changed
- `DataFlow.Data.Read/Read.Yaml.cs` — Added record-aware deserialization path (async + sync)
- `UnitTests/DataFlow.Data.Tests/AdditionalReadTests.cs` — Removed `// BUG:` annotation

## Test Reference
`UnitTests/DataFlow.Data.Tests/AdditionalReadTests.cs` → `Yaml_BasicList_ReadsAllItems`, `YamlSync_BasicList_ReadsAllItems`
