...
namespace iCode.Tests
{
    ...
    public class ScheduleCallTest
    {
        ...
        {
            sharedData = 0;
            iLogger.AddFileLogger(@"C:\Users\Bilel_Alstom\Desktop\iCodeTestsLog\ScheduleCall_Schedule.txt");
        ...
        {
            iLogger.AddFileLogger(@"C:\Users\Bilel_Alstom\Desktop\iCodeTestsLog\ScheduleCall_ScheduleAgainWhileFirstSchedule.txt"); 
